Fae.setup do |config|
  ...
  config.devise_secret_key = '97b68fc77d9cd3cec530faef992152b5acc639683b12249e2da32979e86d28e810b10a845b636e7282c979401582db635ae9d9208830c76c587d10673c4d98fd'


  ## devise_mailer_sender
  # This email address will get passed to Devise and
  # used as the from address in the password reset emails.
  config.devise_mailer_sender = 'theyellows@theyellows.cat'
  ...
  # The default is 5 MB.
  config.max_file_upload_size = 50
